    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4" tabIndex="0">
        ...
        <div class="sidebar">
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                <div class="info">
                    <a href="javascript:void(0)" class="d-block">{{ auth()->user()->name.' ('.auth()->user()->email.')' }}</a>
                </div>
            </div>
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('puslapiai.index') }}" class="nav-link @if (str_contains(url()->current(), 'puslapiai')) active @endif">
