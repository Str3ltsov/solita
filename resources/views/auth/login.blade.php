                ...
                <div class="col-lg-6">
                    <div class="contact__info-wrapper mb-30">
                        <div class="section__title-one mb-20">
                            <h3 class="mb-20">{{ __('Prisijungti') }}</h3>
                            <h2>{{ __('Prisijungti kaip administratorius') }}</h2>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="contact__from-input">
                                        <input id="email" type="email" placeholder="{{ __('El. paštas *') }}"
                                ...
                                <div class="col-lg-12">
                                    <div class="contact__from-input">
                                        <input id="password" type="password" placeholder="{{ __('Slaptažodis *') }}"
                                               class="mt-2 @error('password') is-invalid @enderror" name="password"
                                               required autocomplete="current-password">
                                        @error('password')
                                        <span class="invalid-feedback text-danger" role="alert">
                                            <strong>{{ $message }}</strong>
                                ...
                                <div class="col-12">
                                    <div class="form-check mb-40 mt-10">
                                        <input class="form-check-input remember-me-checkbox" type="checkbox"
                                               name="remember"
                                               id="remember" {{ old('remember') ? 'checked' : '' }}>
                                ...
                                <div class="col-12">
                                    <button class="comment__btn e-btn" type="submit">{{ __('Prisijungti') }}</button>
                                </div>
                            </div>
                        </form>
                    </div>
