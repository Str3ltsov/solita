...
{{--    </main>--}}
    <main>
        <div class="banner5-area pos-rel fix bg-css" data-background="{{ asset('assets/img/hero/globe-bg.jpg') }}" style="background-image: url(&quot;assets/img/hero/globe-bg.jpg&quot;);">
...
{{--                </div>--}}
                <div class="et-tsparticles">
                    <div id="particles-js"><canvas class="particles-js-canvas-el" width="2310" height="1800" style="width: 100%; height: 100%;"></canvas></div>
                </div>
                <div class="container">
                    <div class="row">
                        <div class="col-lg-9 col-md-12">
                            <div class="banner5-content p-relative">
                                ...
                                <h2 class="banner5-title mb-25 wow fadeInUp" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInUp;">Data Science &amp; AI Consulting Company</h2>
                                <div class="banner5-text wow fadeInUp mb-115" data-wow-delay=".7s" style="visibility: visible; animation-delay: 0.7s; animation-name: fadeInUp;">
                                    <p>Because we have 220+ technology talents that can assist you with product development at any stage of the project. Explore our case studies to discover how our partnerships of 4 months to 5 years made businesses in 24 countries .</p>
                                </div>
            ...
            <div class="container">
                <div class="row align-items-center wow fadeInUp" data-wow-delay=".3s" style="visibility: visible; animation-delay: 0.3s; animation-name: fadeInUp;">
                    ...
                    <div class="col-xl-7 col-lg-8">
                        @auth
                            <div class="banner5-btn wow fadeInUp mb-50 ms-md-3" data-wow-delay=".9s" style="visibility: visible; animation-delay: 0.9s; animation-name: fadeInUp;">
                                <div class="about__btn">
                                    <a class="it__btn-3 px-4" href="{{ route('editApieMus') }}">
                                        {{ __('Redaguoti Apie Mus ') }}
