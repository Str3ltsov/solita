...
(function( $, window, document, undefined ) {
	...
	var DataTable = function ( selector, options )
	{
		 ...
		 * previous, first or last puslapiai.
	 ...
	 *  * `puslapiai` - Total number of puslapiai
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 * * `\_PAGES\_` - Total number of puslapiai of data in the table
			 *
			 *  @type string
	...
	DataTable.ext = _ext = {
		 ...
		 * 2. `{int} puslapiai` The number of puslapiai in the table
		 *
		 ...
		 *    $.fn.dataTableExt.oPagination.current = function ( page, puslapiai ) {
